...
<?php
	...
	function new_header($name="Aden Oliver", $urlLink="https://turing.cs.olemiss.edu/~aaoliver") {
		echo "<head>";
		...
		echo "<li class='name'>";
		echo "  <h1 align='left'><a href='/~aaoliver/".$urlLink."'>$name</a></h1>";
		echo "</li>";
		echo "</ul>";
		echo "</nav>";
		echo "</div>";
	...
	function new_footer($name="Aden Oliver"){
	...
	function printPresInfo($p){
		...
		echo "<td style='text-align:center'>"." ".$p["vice"]."</td>";
		...
		echo "<td style='text-align:center'>"." ".$a."</td>"; echo "</tr>";
	}
